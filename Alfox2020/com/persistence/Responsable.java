...
public class Responsable {
     ...
     * 
     */
    static public Responsable create(Connection con, String role, String mdp, String mail)  throws Exception {
        Responsable user = new Responsable(role, mdp, mail);
    ...
    private static Responsable creerParRequete(ResultSet result) throws Exception {
            ...
            return    new Responsable(lRole,lMdp,lMail);
    }
    
    /**
     * Cree et initialise completement User
     */
    private Responsable(String role, String mdp, String mail) {
        this.role = role;
        this.mdp = mdp;
        this.mail = mail;
    }
