...
public class Vehicule { 
    ...
    private Timestamp DateDernierControle; 
    private Timestamp DateDerniereVidange; 
    ...
    static public Vehicule create(Connection con, String Marque, 
            ...
            double KilometrageReel, double KilometrageCumule, int KmVidange, 
            Timestamp DateDernierControle, Timestamp DateDerniereVidange, 
            Timestamp DateControleTechnique) throws Exception {
        Vehicule vehicule = new Vehicule(
            Marque, Modele, Immatriculation, Motorisation,
            DateMiseEnService, HorsZone, TauxUtilisation,
            KilometrageReel, KilometrageCumule, KmVidange, 
            DateDernierControle, DateDerniereVidange, 
        ...
        String queryString =
          "insert into vehicule ((Marque," +
                ...
                + Utils.toString(DateDernierControle) + ", "
                + Utils.toString(DateDerniereVidange) + ", "
    ...
    public void save(Connection con) throws Exception {
        String queryString =
            "update vehicule set "
                ...
                + " CompteurReel =" + Utils.toString(KilometrageReel) + ","
                + " CompteurReel =" + Utils.toString(KilometrageCumule) + ","
                + " KmVidange =" + Utils.toString(KmVidange) + ","
                + " DateDernierControle =" + Utils.toString(DateDernierControle) + ","
                + " DateVidange =" + Utils.toString(DateDerniereVidange) + ","
    ...
    public static int getKmMoyenFlotte(Connection con) throws Exception {
        double totalKm = 0;
        String queryString = "select KilometrageReel from vehicule";
        Statement lStat = con.createStatement(
                                ResultSet.TYPE_SCROLL_INSENSITIVE, 
                                ResultSet.CONCUR_READ_ONLY);
        ResultSet lResult = lStat.executeQuery(queryString);
        ...
        while (lResult.next()) {
            lstCompteurReel.add(lResult.getDouble("KilometrageReel"));
        }
    ...
    public static int nbVehiculesDehors(Connection con) throws Exception {
        ...
        for (int i = 0 ; i < lstVehicule.size() ; i++) {
            if (lstVehicule.get(i).isHorsZone(con)) {
                nbVehiculesDehors += 1;
            }
        }
    ...
    */
    ...
    private static Vehicule creerParRequete(ResultSet result) throws Exception {
        ...
        double lKilometrageReel = result.getDouble("lKilometrageReel");
        double lKilometrageCumule = result.getDouble("lKilometrageCumule");
        int lKmVidange = result.getInt("lKmVidange");
        Timestamp lDateDernierControle = result.getTimestamp("lDateDernierControle");
        Timestamp lDateDerniereVidange = result.getTimestamp("lDateDerniereVidange");
        ...
        return new Vehicule(lMarque, lModele, lImmatriculation, lMotorisation,
            ...
            lKilometrageCumule, lKmVidange, lDateDernierControle, lDateDerniereVidange, 
    ...
    private Vehicule(String Marque, 
            ...
            double KilometrageReel, double KilometrageCumule, int KmVidange, 
            Timestamp DateDernierControle, Timestamp DateDerniereVidange, 
            Timestamp DateControleTechnique) {
        this.Marque = Marque;
        this.Modele = Modele;
    ...
    public Timestamp getDateDernierControle() {
        return DateDernierControle;
    }

    public void setDateDernierControle(Timestamp DateDernierControle) {
        this.DateDernierControle = DateDernierControle;
    }

    public Timestamp getDateDerniereVidange() {
        return DateDerniereVidange;
    }

    public void setDateDerniereVidange(Timestamp DateDerniereVidange) {
        this.DateDerniereVidange = DateDerniereVidange;
    }
    ...
    // --------------------- les assesseurs ----------------------------
    public void setDateControleTechnique(Timestamp DateControleTechnique) {
        this.DateControleTechnique = DateControleTechnique;
    }
